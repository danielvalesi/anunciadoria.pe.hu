jQuery(window).load(function() {
	...
	$(".menutoggle").click(function () {
		...
		if ($('body').hasClass('left_nav_hide')) {
			if(fix==1 && windowsize > 960) $('body').addClass('left_nav_fixed');
			$('body').removeClass('left_nav_hide');
			
			if(windowsize < 960) $('body').addClass('_fix-awalke');
		} 
		else {
			...
			if(windowsize < 960) $('body').removeClass('_fix-awalke');
	...
	$(window).resize(function() {
	  ...
	  {  
		if($('body').hasClass('_fix-awalke')) $('body').removeClass('_fix-awalke');
		...
		{
			if(!$('body').hasClass('left_nav_fixed')) $('body').addClass('left_nav_fixed');
		}
	  }
		$('.slimScrollDiv').css('height',displayheight-80);
		$('.left_nav_slidebar').css('height',displayheight-80);
